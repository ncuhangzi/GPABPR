...
class GPABPR(Module):
    ...
    def forward(self, batch, visual_features, text_features, can_s,**args):
        ...
        Ks = ['41212721','20194839','39374475','6184202','10086165','33191619','9294575','33655023','5017754','6021420','36147738','9422813','12265429','15598659','41684665','38849314','33059049','20458902','43841533']
            ...
            with torch.cuda.device(self.visual_nn[0].weight.data.get_device()):
                ...
                for K in Ks:
                    with torch.cuda.stream(stream2):
                        ...
                        f_ik = torch.tensor(cuk.cpu().detach().numpy())
